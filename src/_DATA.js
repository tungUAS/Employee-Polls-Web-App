export const users = [
    ...
    },
    {
      id: 4,
      name: "Tom",
      avatar_url: "https://gravatar.com/avatar/17461862a35eb112646cd5f27097ca85?s=400&d=robohash&r=x",
    },
  ];
...
export const _addAnsweredByQuestion = (authedUser, questionId) => {
  console.log(authedUser, questionId);
    return new Promise((res, rej) => {
      setTimeout(() => {
        questions.find((question) => question.id === questionId).answered_by.push(authedUser);
        res();
      }, 500);
    });
  }
